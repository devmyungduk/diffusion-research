...
??? note "Inpainting과 함께 사용할 때의 연결 순서"
...
| 에러 메시지 | 원인 | 해결 방법 |
|:-----------|:-----|:---------|
| `Out of memory (OOM)` | VRAM 초과 | 1. 해상도와 `batch_size` 낮추기<br>2. FP16 → FP8 전환<br>3. `t5xxl_fp16` → `t5xxl_fp8`<br>4. GGUF Q6/Q5 사용<br>5. [실행 플래그 조정](../../05-troubleshooting/README.md#2-메모리-관련-문제) |

IPAdapter 관련 에러는 [IPAdapter 문제 해결](ipadapter.md#6-문제-해결)에 있습니다.
...
??? note "공식 문서·모델 다운로드 링크 펼치기"
    ...
    | Flux | [Black Forest Labs 공식 저장소](https://github.com/black-forest-labs/flux) |
    ...
    | 사용처 | 저장소 |
    |:--------|:-------|
    | SD 1.5 · SDXL | [h94/IP-Adapter](https://huggingface.co/h94/IP-Adapter) |
    | Flux (XLabs) | [XLabs-AI/flux-ip-adapter-v2](https://huggingface.co/XLabs-AI/flux-ip-adapter-v2) |
    | Flux (InstantX) | [InstantX/FLUX.1-dev-IP-Adapter](https://huggingface.co/InstantX/FLUX.1-dev-IP-Adapter) |

    #### Flux 모델

    | 용도 | 저장소 |
    |:-----|:-------|
    | 범용 생성 | [black-forest-labs/FLUX.1-dev](https://huggingface.co/black-forest-labs/FLUX.1-dev) |
    | 인페인팅·아웃페인팅 | [black-forest-labs/FLUX.1-Fill-dev](https://huggingface.co/black-forest-labs/FLUX.1-Fill-dev) |
    | FP8 양자화 | [Kijai/flux-fp8](https://huggingface.co/Kijai/flux-fp8) |
    | GGUF 양자화 | [city96/FLUX.1-dev-gguf](https://huggingface.co/city96/FLUX.1-dev-gguf) |

    #### ControlNet 모델

    | 제공자 | 저장소 |
    |:-------|:-------|
    | XLabs | [XLabs-AI/flux-controlnet-collections](https://huggingface.co/XLabs-AI/flux-controlnet-collections) |
    | InstantX | [InstantX/FLUX.1-dev-Controlnet-Union](https://huggingface.co/InstantX/FLUX.1-dev-Controlnet-Union) |
