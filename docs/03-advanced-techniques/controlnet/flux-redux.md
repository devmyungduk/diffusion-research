...
A. Load Image, CLIP Vision Encode, StyleModelApply, BasicGuider의 포트 연결을 차례로 확인합니다. 실행과 비교 절차는 [Redux 확인과 비교 실험](../../02-models/flux/redux-tuning.md#3-첫-비교-실험)을 따릅니다.
...
- Redux와 ControlNet 중 어느 쪽을 사용할지 목적으로 판단할 수 있다.
