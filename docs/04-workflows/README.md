...
- 바로 쓰는 예제 모음입니다. Inpainting·업스케일 등 목적별 워크플로우를 복사해 시작점으로 활용하세요.
- 목적별 워크플로우의 노드 구성과 설정 예시
- Image-to-Image, 업스케일, 배치 생성의 연결 순서
- 복잡한 노드 구성을 한눈에 파악하는 예제

<div class="guide-meta" markdown>
**대상** 이론보다는 실제 "돌아가는 예제"가 필요한 사용자 · **사전 이해** ComfyUI 노드 추가/연결 방법 · **시간** 5분 (탐색 시간)
...
업스케일과 배치 생성은 [다음 장](upscale-and-batch.md)에서 다룹니다.
...
처음이라면 [빠른 시작의 모델별 시작값](../00-getting-started/quick-start.md#4-첫-실행값-넣기)을 그대로 쓰세요.
...
graph LR
    ...
    VE -->|LATENT| KS["KSampler<br/>denoise 1.0 미만"]
    TE["CLIP Text Encode<br/>바꾸고 싶은 방향"] --> KS
...
로더는 `Load LoRA (Model and CLIP)`을 씁니다([LoRA 가이드](../03-advanced-techniques/lora/README.md#comfyui에서-사용하기)).
