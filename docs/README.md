...
![프롬프트에서 노이즈와 디노이징 단계를 거쳐 이미지가 만들어지는 학습서 표지](assets/images/diffusion-learning-hero.webp){ width="2172" height="724" }
...
| 프롬프트를 의도대로 작성하고 싶다 | [프롬프트와 CLIP 이해하기](./00-getting-started/prompt-basics.md) |
| 이미지가 만들어지는 원리가 궁금하다 | [핵심 개념](./01-core-concepts/README.md) |
| Flux 모델을 사용하고 싶다 | [Flux 가이드](./02-models/flux/README.md) |
...
### 입문 — 첫 이미지까지
ComfyUI 설치부터 첫 이미지 생성까지.
- [00. 시작하기](./00-getting-started/README.md)
  - [ComfyUI 설치](./00-getting-started/installation.md) — 약 15분
  - [모델 준비](./00-getting-started/models.md) — 약 15분
  - [캔버스 다루기](./00-getting-started/canvas-basics.md) — 약 5분
  - [5분 빠른 시작](./00-getting-started/quick-start.md) — 약 5분
  - [노드 다루기](./00-getting-started/node-basics.md) — 약 15분
  - [실행과 중단](./00-getting-started/run-and-stop.md) — 약 10분
  - [워크플로우 이해하기](./00-getting-started/workflow-basics.md) — 약 30분
  - [프롬프트와 CLIP 이해하기](./00-getting-started/prompt-basics.md) — 약 20분
  - [첫 워크플로우 직접 만들기](./00-getting-started/first-workflow.md) — 약 40분
...
- **Flux**
  ...
  - [guidance 값 비교와 연결](./02-models/flux/guidance-tuning.md)
  - [FLUX.1 작업 선택과 Redux 실습](./02-models/flux/flux-practical.md)
  - [Redux 확인과 비교 실험](./02-models/flux/redux-tuning.md)
  - [Flux 빠른 참조](./02-models/flux/quick-reference.md)
- **SD·SDXL**
...
- [ComfyUI 공식 예제](https://comfyanonymous.github.io/ComfyUI_examples/) — 모델별 워크플로우 원본. 예제 이미지를 캔버스에 끌어다 놓으면 그대로 열립니다
