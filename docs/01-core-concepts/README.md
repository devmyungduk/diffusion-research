...
![난이도](https://img.shields.io/badge/난이도-초급-green?style=for-the-badge)
![소요시간](https://img.shields.io/badge/소요시간-30분-blue?style=for-the-badge)
![필요지식](https://img.shields.io/badge/필요지식-없음-success?style=for-the-badge)

---

## 🤔 이런 분들을 위한 가이드예요

✅ "AI 그림이 어떻게 만들어지는지 궁금해요"  
✅ "Latent? VAE? 용어가 너무 어려워요"  
✅ "ComfyUI 노드 연결은 했는데 원리를 모르겠어요"  
...
ComfyUI와 Stable Diffusion의 **핵심 개념**을 다뤄요.

**학습 목표:**
- Latent Image가 뭔지 이해하기
- VAE의 역할 파악하기
- UNet vs Transformer 차이 알기
- 모델 구성 요소 구분하기
...
![난이도](https://img.shields.io/badge/난이도-초급-green)
![소요시간](https://img.shields.io/badge/5분-blue)

### 🤔 이런 분들을 위한 섹션이에요

- "Latent가 뭔지 하나도 모르겠어요" ← 딱 맞아요!
- "압축? 설계도? 무슨 말이에요?" ← 여기서 시작해요!
...
- "VAE가 뭔지 모르겠어요" ← 걱정 마세요!
- "이미지가 안 나와요" ← 아마 VAE 때문일 거예요!
...
![난이도](https://img.shields.io/badge/난이도-중급-orange)
![소요시간](https://img.shields.io/badge/10분-blue)

### 🤔 이런 분들을 위한 섹션이에요

- "UNet? Transformer? 무슨 차이예요?" ← 설명드릴게요!
- "Flux가 왜 더 좋다는 거예요?" ← 여기서 알 수 있어요!
...
- "Checkpoint? UNet? 뭐가 뭔지 모르겠어요" ← 정리해드릴게요!
- "ComfyUI 노드가 너무 많아요" ← 핵심만 알려드릴게요!
...
![](https://img.shields.io/badge/🎓-Core_Concepts_Master-gold?style=for-the-badge)
...
1. [모델별 가이드](../02-models/flux/README.md) - 실제 사용법
2. [워크플로우](../04-workflows/README.md) - 실전 적용
3. [고급 기술](../03-advanced-techniques/lora/README.md) - 심화 학습
...
<details>
<summary>Q1. Latent Image는 왜 사용하나요?</summary>

**A.** 50배 빠르게 처리하려고!

실제 이미지는 데이터가 너무 많아요.  
Latent로 압축하면 빠르게 작업할 수 있어요!
</details>

<details>
<summary>Q2. VAE Decode를 거치지 않으면 어떻게 되나요?</summary>

**A.** 이미지가 안 보여요!

Latent는 압축된 상태라 볼 수 없어요.  
반드시 VAE Decode로 압축을 풀어야 해요!
</details>

<details>
<summary>Q3. Flux가 SD보다 프롬프트 이해가 좋은 이유는?</summary>

**A.** Transformer 구조 때문이에요!

Transformer는 전체를 한눈에 보기 때문에  
텍스트와 이미지 관계를 정확히 파악해요!
</details>

<details>
<summary>Q4. Checkpoint 파일에는 무엇이 포함되나요?</summary>

**A.** UNet/DiT + VAE + Text Encoder!

완성된 자동차처럼 필요한 모든 게 들어있어요!
</details>
